...
I specialize in JavaScript technologies like **Astro**, **React**, **Next.js**, **Node.js**, **Express.js**, **Python**, **Nest.js**, **MongoDB**, and **Supabase**, and have recently been building **AI-powered tools**, **SaaS MVPs**, and \*\*e-commerce platforms\*\* that focus on speed, usability, and scalability.
